...
<div class="container p-3 my-3">
	<h1><i class="fa fa-align-justify"></i> 상품 판매 리스트</h1>
				...
				<div class="col-md-4 dataRow">
					<div class="card" style="width:100%">
						<div class="imageDiv align-content-center text-center">
					  	<img class="card-img-top" src="${vo.imageName }" alt="Card image">
					  </div>
					  <div class="card-body title">
					    <h4 class="card-title">
					    	<div class="row">
					    		<div class="col-5"><h6>상품번호</h6></div>
					    		<div class="col-7 gno"><h5>${vo.gno }</h5></div>
					    	</div>
					    	<div class="row">
					    		<div class="col-5"><h6>상품명</h6></div>
					    		<div class="col-7"><h5>${vo.name }</h5></div>
					    	</div>
					    </h4>
					    <p class="card-text">
					    	<div class="row">
					    		<div class="col-5">정가</div>
					    		<div class="col-7"
					    	...
					    	<div class="row">
					    		...
					    		<div class="col-7"><h5>${vo.discount }</h5></div>
					    	</div>
							</p>
					  </div>
					</div><!-- end of card -->
